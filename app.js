...
const BONUS_STARTERS=["Salade de mâche, betterave et noix", "Carpaccio de champignons de Paris et parmesan", "Velouté froid de courgette à la menthe", "Salade de pousses d'épinards, orange et grenade", "Tomates cœur de bœuf, burrata légère et basilic", "Salade de radis, fenouil et pamplemousse", "Asperges vertes vapeur, vinaigrette citronnée", "Salade de chou kale, pomme verte et citron", "Carpaccio de betterave crue au cumin", "Salade de haricots verts, tomates séchées et amandes", "Concombre, pastèque et feta légère", "Salade de poivrons multicolores grillés", "Velouté froid de concombre à l'aneth", "Salade de roquette, figues et vinaigre balsamique", "Carottes et oranges à la fleur d'oranger", "Salade de champignons, noisettes et persil", "Tartare de tomates, câpres et échalote", "Salade de courgettes jaunes et vertes au citron", "Endives, pomme et noix en salade croquante", "Salade de betterave, orange et coriandre fraîche", "Salade de radis et herbes fraîches", "Carpaccio de poireaux vinaigrette et ciboulette", "Velouté froid de tomates anciennes et basilic", "Carpaccio de carottes et gingembre confit", "Salade de haricots verts et amandes", "Tartare de céleri rémoulade léger", "Tartare d'aubergines fumées et yaourt", "Poêlée tiède d'aubergines fumées et yaourt", "Velouté froid de poireaux vinaigrette et ciboulette", "Salade d'oignons rouges confits et thym", "Velouté froid de concombre et menthe fraîche", "Carpaccio d'artichauts violets et citron", "Salade de panais rôti et noisette", "Tartare de poivrons rôtis et coriandre", "Salade d'aubergines fumées et yaourt", "Carpaccio de tomates anciennes et basilic", "Poêlée tiède d'oignons rouges confits et thym", "Tartare de radis et herbes fraîches", "Carpaccio de radis noir et citron", "Carpaccio de roquette et figues fraîches", "Velouté froid de betterave et pomme verte", "Salade de roquette et figues fraîches", "Velouté froid d'asperges vertes et citron", "Velouté froid d'endives et pomme granny", "Carpaccio de poivrons rôtis et coriandre", "Tartare de fenouil et pamplemousse", "Velouté froid de céleri rémoulade léger", "Carpaccio de petits pois et menthe", "Carpaccio de courge butternut rôtie et sauge", "Tartare de pousses d'épinards et grenade", "Poêlée tiède d'endives et pomme granny", "Salade de champignons crus et noisettes", "Salade de courge butternut rôtie et sauge", "Velouté froid de carottes et gingembre confit", "Velouté froid de champignons crus et noisettes", "Poêlée tiède de roquette et figues fraîches", "Tartare de tomates anciennes et basilic", "Tartare de champignons crus et noisettes", "Poêlée tiède de haricots verts et amandes", "Carpaccio d'aubergines fumées et yaourt", "Tartare de panais rôti et noisette", "Carpaccio d'oignons rouges confits et thym", "Velouté froid de roquette et figues fraîches", "Velouté froid de courge butternut rôtie et sauge", "Salade de concombre et menthe fraîche", "Carpaccio de pousses d'épinards et grenade", "Velouté froid de pousses d'épinards et grenade", "Poêlée tiède de carottes et gingembre confit", "Velouté froid d'oignons rouges confits et thym", "Carpaccio de fenouil et pamplemousse", "Poêlée tiède de radis et herbes fraîches", "Velouté froid de petits pois et menthe", "Tartare de betterave et pomme verte", "Salade de céleri rémoulade léger", "Salade d'endives et pomme granny", "Poêlée tiède de champignons crus et noisettes", "Tartare de courgettes crues et parmesan", "Velouté froid de radis et herbes fraîches", "Poêlée tiède de betterave et pomme verte", "Poêlée tiède de pousses d'épinards et grenade", "Poêlée tiède de radis noir et citron", "Salade de radis noir et citron", "Carpaccio de betterave et pomme verte", "Poêlée tiède de poireaux vinaigrette et ciboulette", "Poêlée tiède de tomates anciennes et basilic", "Salade d'artichauts violets et citron", "Tartare de betterave jaune et noisette", "Poêlée tiède de courge butternut rôtie et sauge", "Carpaccio de champignons crus et noisettes", "Carpaccio de chou rouge et grenade", "Poêlée tiède de betterave jaune et noisette", "Salade d'asperges vertes et citron", "Poêlée tiède de courgettes crues et parmesan", "Poêlée tiède de concombre et menthe fraîche", "Salade de pousses d'épinards et grenade", "Salade de tomates anciennes et basilic", "Poêlée tiède de chou rouge et grenade", "Tartare de poireaux vinaigrette et ciboulette", "Poêlée tiède de panais rôti et noisette", "Salade de fenouil et pamplemousse"];
const BONUS_LUNCHES=[{"entree": "Salade de mâche, betterave et noix", "plat": "Filet de cabillaud vapeur, citron et aneth + quinoa + haricots verts"}, {"entree": "Carpaccio de champignons de Paris et parmesan", "plat": "Poulet rôti aux herbes de Provence + riz complet + poêlée de courgettes"}, {"entree": "Velouté froid de courgette à la menthe", "plat": "Dinde sautée au paprika doux + boulgour complet + poivrons et oignons"}, {"entree": "Salade de pousses d'épinards, orange et grenade", "plat": "Pavé de saumon grillé + riz complet + brocoli vapeur"}, {"entree": "Tomates cœur de bœuf, burrata légère et basilic", "plat": "Filet de dorade en croûte d'herbes + patate douce rôtie + épinards"}, {"entree": "Salade de radis, fenouil et pamplemousse", "plat": "Sauté de bœuf au gingembre + riz complet + pak-choï"}, {"entree": "Asperges vertes vapeur, vinaigrette citronnée", "plat": "Brochettes de crevettes citron-ail + boulgour complet + courgettes grillées"}, {"entree": "Salade de chou kale, pomme verte et citron", "plat": "Escalope de dinde à la moutarde + lentilles corail + haricots verts"}, {"entree": "Carpaccio de betterave crue au cumin", "plat": "Filet de merlan meunière léger + riz complet + carottes vapeur"}, {"entree": "Salade de haricots verts, tomates séchées et amandes", "plat": "Poulet grillé au citron confit + pois chiches + ratatouille"}, {"entree": "Concombre, pastèque et feta légère", "plat": "Tajine de veau léger aux légumes + semoule complète + carottes"}, {"entree": "Salade de poivrons multicolores grillés", "plat": "Filet de sole vapeur + quinoa + fenouil braisé"}, {"entree": "Velouté froid de concombre à l'aneth", "plat": "Brochettes de dinde marinées au yaourt + riz complet + concombre grillé"}, {"entree": "Salade de roquette, figues et vinaigre balsamique", "plat": "Gambas au curry doux et lait de coco léger + riz complet + brocoli"}, {"entree": "Carottes et oranges à la fleur d'oranger", "plat": "Filet de bœuf grillé, sauce au poivre légère + patate douce + haricots verts"}, {"entree": "Salade de champignons, noisettes et persil", "plat": "Poulet basquaise + semoule complète + poivrons"}, {"entree": "Tartare de tomates, câpres et échalote", "plat": "Pavé de thon mi-cuit sésame + riz complet + edamame et carottes"}, {"entree": "Salade de courgettes jaunes et vertes au citron", "plat": "Filet de daurade en papillote citron-fenouil + boulgour complet + courgettes"}, {"entree": "Endives, pomme et noix en salade croquante", "plat": "Escalope de veau à l'estragon + lentilles vertes + haricots verts"}, {"entree": "Salade de betterave, orange et coriandre fraîche", "plat": "Poulet rôti au thym citron + riz complet + ratatouille"}, {"entree": "Salade de radis et herbes fraîches", "plat": "Filet de sole grillé au citron + sarrasin + chou-fleur vapeur"}, {"entree": "Carpaccio de poireaux vinaigrette et ciboulette", "plat": "Filet de colin à l'estragon + semoule complète + fenouil braisé"}, {"entree": "Velouté froid de tomates anciennes et basilic", "plat": "Steak de bœuf rôti à l'ail + riz complet aux herbes + épinards sautés"}, {"entree": "Carpaccio de carottes et gingembre confit", "plat": "Blanc de poulet mariné au paprika doux + pois chiches citronnés + carottes rôties"}, {"entree": "Salade de haricots verts et amandes", "plat": "Blanc de poulet en tranches fines au romarin + patate douce rôtie + épinards sautés"}, {"entree": "Tartare de céleri rémoulade léger", "plat": "Pavé de saumon mariné au paprika doux + pois chiches citronnés + brocoli vapeur"}, {"entree": "Tartare d'aubergines fumées et yaourt", "plat": "Cuisse de poulet sans peau au four à l'ail et au thym + boulgour complet + carottes rôties"}, {"entree": "Poêlée tiède d'aubergines fumées et yaourt", "plat": "Filet de sole mariné au citron vert + pâtes complètes + carottes rôties"}, {"entree": "Velouté froid de poireaux vinaigrette et ciboulette", "plat": "Pavé de thon poêlé à la moutarde + patate douce rôtie + chou-fleur vapeur"}, {"entree": "Salade d'oignons rouges confits et thym", "plat": "Pavé de thon vapeur à l'aneth + pâtes complètes + chou-fleur vapeur"}, {"entree": "Velouté froid de concombre et menthe fraîche", "plat": "Filet de merlan rôti à l'ail + quinoa + poivrons grillés"}, {"entree": "Carpaccio d'artichauts violets et citron", "plat": "Noix de Saint-Jacques rôties aux herbes de Provence + riz complet + fenouil braisé"}, {"entree": "Salade de panais rôti et noisette", "plat": "Noix de Saint-Jacques rôties à l'ail + lentilles corail + poêlée de courgettes"}, {"entree": "Tartare de poivrons rôtis et coriandre", "plat": "Escalope de dinde à l'estragon + semoule complète + carottes rôties"}, {"entree": "Salade d'aubergines fumées et yaourt", "plat": "Escalope de veau à l'estragon + semoule complète + haricots verts"}, {"entree": "Carpaccio de tomates anciennes et basilic", "plat": "Gambas grillées au citron + pois chiches citronnés + ratatouille légère"}, {"entree": "Poêlée tiède d'oignons rouges confits et thym", "plat": "Blanc de poulet à l'estragon + semoule complète + poivrons grillés"}, {"entree": "Tartare de radis et herbes fraîches", "plat": "Escalope de dinde sautée à l'ail et au persil + quinoa + épinards sautés"}, {"entree": "Carpaccio de radis noir et citron", "plat": "Filet de poulet poêlé à la moutarde + pâtes complètes + brocoli vapeur"}, {"entree": "Carpaccio de roquette et figues fraîches", "plat": "Escalope de veau grillée au poivre + semoule complète + poivrons grillés"}, {"entree": "Velouté froid de betterave et pomme verte", "plat": "Filet de daurade royale à l'estragon + pois chiches citronnés + poivrons grillés"}, {"entree": "Salade de roquette et figues fraîches", "plat": "Cuisse de poulet sans peau rôtie aux herbes de Provence + sarrasin + brocoli vapeur"}, {"entree": "Velouté froid d'asperges vertes et citron", "plat": "Pavé de thon en croûte d'herbes fraîches + quinoa + poêlée de courgettes"}, {"entree": "Velouté froid d'endives et pomme granny", "plat": "Filet de colin rôti à l'ail + riz complet aux herbes + brocoli vapeur"}, {"entree": "Carpaccio de poivrons rôtis et coriandre", "plat": "Langouste sautée à l'ail et au persil + lentilles corail + carottes rôties"}, {"entree": "Tartare de fenouil et pamplemousse", "plat": "Gambas rôties aux herbes de Provence + pâtes complètes + haricots verts"}, {"entree": "Velouté froid de céleri rémoulade léger", "plat": "Filet de poulet en croûte d'herbes fraîches + quinoa + carottes rôties"}, {"entree": "Carpaccio de petits pois et menthe", "plat": "Escalope de veau poêlée minute au paprika + boulgour complet + salade croquante"}, {"entree": "Carpaccio de courge butternut rôtie et sauge", "plat": "Filet de bar mariné au citron vert + quinoa + ratatouille légère"}, {"entree": "Tartare de pousses d'épinards et grenade", "plat": "Filet de cabillaud poêlé à la moutarde + sarrasin + poivrons grillés"}, {"entree": "Poêlée tiède d'endives et pomme granny", "plat": "Steak de bœuf grillé au citron + riz complet + poêlée de courgettes"}, {"entree": "Salade de champignons crus et noisettes", "plat": "Filet de rouget rôti aux herbes de Provence + boulgour complet + brocoli vapeur"}, {"entree": "Salade de courge butternut rôtie et sauge", "plat": "Crevettes en tranches fines au romarin + semoule complète + carottes rôties"}, {"entree": "Velouté froid de carottes et gingembre confit", "plat": "Filet mignon de porc au four à l'ail et au thym + boulgour complet + haricots verts"}, {"entree": "Velouté froid de champignons crus et noisettes", "plat": "Filet de poulet mariné au paprika doux + pois chiches citronnés + ratatouille légère"}, {"entree": "Poêlée tiède de roquette et figues fraîches", "plat": "Filet de bœuf grillé au citron + pâtes complètes + haricots verts"}, {"entree": "Tartare de tomates anciennes et basilic", "plat": "Filet de merlan sauté à l'ail et au persil + semoule complète + poêlée de courgettes"}, {"entree": "Tartare de champignons crus et noisettes", "plat": "Blanc de poulet au wok gingembre-citronnelle + riz complet aux herbes + chou-fleur vapeur"}, {"entree": "Poêlée tiède de haricots verts et amandes", "plat": "Pavé de saumon rôti à l'ail + lentilles corail + ratatouille légère"}, {"entree": "Carpaccio d'aubergines fumées et yaourt", "plat": "Cuisse de poulet sans peau à l'estragon + riz complet + fenouil braisé"}, {"entree": "Tartare de panais rôti et noisette", "plat": "Filet de colin en croûte d'herbes fraîches + riz complet + ratatouille légère"}, {"entree": "Carpaccio d'oignons rouges confits et thym", "plat": "Blanc de poulet au four à l'ail et au thym + patate douce rôtie + haricots verts"}, {"entree": "Velouté froid de roquette et figues fraîches", "plat": "Crevettes vapeur à l'aneth + lentilles corail + salade croquante"}, {"entree": "Velouté froid de courge butternut rôtie et sauge", "plat": "Rôti de veau en croûte d'herbes fraîches + pâtes complètes + carottes rôties"}, {"entree": "Salade de concombre et menthe fraîche", "plat": "Gambas poêlées à la moutarde + semoule complète + ratatouille légère"}, {"entree": "Carpaccio de pousses d'épinards et grenade", "plat": "Noix de Saint-Jacques sautées à l'ail et au persil + pâtes complètes + chou-fleur vapeur"}, {"entree": "Velouté froid de pousses d'épinards et grenade", "plat": "Filet de bar sauté à l'ail et au persil + riz complet + poêlée de courgettes"}, {"entree": "Poêlée tiède de carottes et gingembre confit", "plat": "Filet mignon de porc mariné au citron vert + quinoa + poêlée de courgettes"}, {"entree": "Velouté froid d'oignons rouges confits et thym", "plat": "Rôti de veau rôti aux herbes de Provence + patate douce rôtie + haricots verts"}, {"entree": "Carpaccio de fenouil et pamplemousse", "plat": "Filet de bœuf mariné au paprika doux + riz complet + épinards sautés"}, {"entree": "Poêlée tiède de radis et herbes fraîches", "plat": "Langouste poêlée minute au paprika + quinoa + fenouil braisé"}, {"entree": "Velouté froid de petits pois et menthe", "plat": "Filet de sole en tranches fines au romarin + quinoa + chou-fleur vapeur"}, {"entree": "Tartare de betterave et pomme verte", "plat": "Filet de colin sauté à l'ail et au persil + patate douce rôtie + salade croquante"}, {"entree": "Salade de céleri rémoulade léger", "plat": "Filet de bœuf rôti aux herbes de Provence + quinoa + fenouil braisé"}, {"entree": "Salade d'endives et pomme granny", "plat": "Pavé de thon en tranches fines au romarin + pois chiches citronnés + ratatouille légère"}, {"entree": "Poêlée tiède de champignons crus et noisettes", "plat": "Escalope de veau en tranches fines au romarin + boulgour complet + poivrons grillés"}, {"entree": "Tartare de courgettes crues et parmesan", "plat": "Filet de merlan poêlé à la moutarde + riz complet + poivrons grillés"}, {"entree": "Velouté froid de radis et herbes fraîches", "plat": "Filet de dorade mariné au citron vert + pâtes complètes + épinards sautés"}, {"entree": "Poêlée tiède de betterave et pomme verte", "plat": "Noix de Saint-Jacques en tranches fines au romarin + patate douce rôtie + haricots verts"}, {"entree": "Poêlée tiède de pousses d'épinards et grenade", "plat": "Filet de bœuf au wok gingembre-citronnelle + riz complet aux herbes + poivrons grillés"}, {"entree": "Poêlée tiède de radis noir et citron", "plat": "Filet de bar au four à l'ail et au thym + pâtes complètes + carottes rôties"}, {"entree": "Salade de radis noir et citron", "plat": "Filet mignon de porc vapeur à l'aneth + pâtes complètes + ratatouille légère"}, {"entree": "Carpaccio de betterave et pomme verte", "plat": "Escalope de veau sautée à l'ail et au persil + patate douce rôtie + carottes rôties"}, {"entree": "Poêlée tiède de poireaux vinaigrette et ciboulette", "plat": "Noix de Saint-Jacques grillées au citron + pois chiches citronnés + haricots verts"}, {"entree": "Poêlée tiède de tomates anciennes et basilic", "plat": "Escalope de veau marinée au citron vert + riz complet + chou-fleur vapeur"}, {"entree": "Salade d'artichauts violets et citron", "plat": "Filet de dorade grillé au poivre + riz complet aux herbes + carottes rôties"}, {"entree": "Tartare de betterave jaune et noisette", "plat": "Noix de Saint-Jacques en croûte d'herbes fraîches + pâtes complètes + ratatouille légère"}, {"entree": "Poêlée tiède de courge butternut rôtie et sauge", "plat": "Filet de merlan rôti aux herbes de Provence + sarrasin + brocoli vapeur"}, {"entree": "Carpaccio de champignons crus et noisettes", "plat": "Filet mignon de porc en croûte d'herbes fraîches + riz complet + carottes rôties"}, {"entree": "Carpaccio de chou rouge et grenade", "plat": "Escalope de dinde en tranches fines au romarin + pâtes complètes + haricots verts"}, {"entree": "Poêlée tiède de betterave jaune et noisette", "plat": "Filet de bœuf en tranches fines au romarin + pois chiches citronnés + salade croquante"}, {"entree": "Salade d'asperges vertes et citron", "plat": "Filet de poulet au four à l'ail et au thym + boulgour complet + poivrons grillés"}, {"entree": "Poêlée tiède de courgettes crues et parmesan", "plat": "Filet de bœuf rôti aux herbes de Provence + riz complet + carottes rôties"}, {"entree": "Poêlée tiède de concombre et menthe fraîche", "plat": "Filet de daurade royale mariné au citron vert + riz complet aux herbes + épinards sautés"}, {"entree": "Salade de pousses d'épinards et grenade", "plat": "Noix de Saint-Jacques en croûte d'herbes fraîches + patate douce rôtie + épinards sautés"}, {"entree": "Salade de tomates anciennes et basilic", "plat": "Crevettes rôties à l'ail + pâtes complètes + chou-fleur vapeur"}, {"entree": "Poêlée tiède de chou rouge et grenade", "plat": "Filet de bar à l'estragon + riz complet aux herbes + fenouil braisé"}, {"entree": "Tartare de poireaux vinaigrette et ciboulette", "plat": "Suprême de poulet au wok gingembre-citronnelle + riz complet aux herbes + fenouil braisé"}, {"entree": "Poêlée tiède de panais rôti et noisette", "plat": "Filet de daurade royale poêlé à la moutarde + pâtes complètes + salade croquante"}, {"entree": "Salade de fenouil et pamplemousse", "plat": "Filet de lieu noir au wok gingembre-citronnelle + sarrasin + ratatouille légère"}];
const BONUS_DINNERS=["Filet de cabillaud vapeur, citron et aneth + poêlée de haricots verts et champignons", "Blanc de poulet grillé aux herbes + salade de concombre, menthe et citron", "Omelette aux asperges et fines herbes + salade de roquette et tomates", "Pavé de saumon grillé, sauce citron léger + épinards sautés à l'ail", "Filet de dorade en papillote de fenouil + courgettes grillées", "Carpaccio de bœuf mariné au citron + salade de roquette et parmesan", "Brochettes de crevettes au paprika + poêlée de poivrons et oignons", "Escalope de dinde grillée + salade de chou kale et pomme verte", "Filet de merlan vapeur, beurre de citron léger + brocoli vapeur", "Tartare de daurade au citron vert + salade de fenouil et orange", "Blanc de poulet au four, herbes de Provence + ratatouille", "Filet de sole vapeur + asperges vertes et champignons", "Œufs cocotte à la tomate et basilic + salade verte et concombre", "Gambas grillées à l'ail et au persil + poêlée de courgettes et champignons", "Filet de bœuf grillé au poivre + salade de betterave et roquette", "Poulet grillé au citron confit + poêlée d'aubergines et poivrons", "Pavé de thon mi-cuit au sésame + salade de chou rouge et carottes", "Carpaccio de saumon aux agrumes + salade de fenouil et radis", "Escalope de veau au citron + poêlée d'épinards et champignons", "Filet de cabillaud rôti aux herbes + salade de courgettes et menthe", "Filet de dorade au wok gingembre-citronnelle + fenouil braisé et orange", "Filet de bar poêlé minute au paprika + aubergines rôties et poivrons", "Filet de poulet en tranches fines au romarin + salade de fenouil et orange", "Filet de colin rôti à l'ail + salade de roquette et parmesan", "Escalope de veau grillée au citron + épinards et pignons de pin", "Gambas à l'estragon + champignons et persillade", "Gambas marinées au paprika doux + poêlée méditerranéenne", "Gambas rôties aux herbes de Provence + salade de betterave et roquette", "Filet de bar sauté à l'ail et au persil + poivrons et oignons confits", "Noix de Saint-Jacques sautées à l'ail et au persil + salade de tomates et basilic", "Filet mignon de porc mariné au paprika doux + chou rouge et carottes râpées", "Escalope de veau en tranches fines au romarin + champignons et persillade", "Suprême de poulet au wok gingembre-citronnelle + salade de roquette et parmesan", "Filet de daurade royale rôti à l'ail + fenouil braisé et orange", "Rôti de veau à l'estragon + chou-fleur rôti et curcuma", "Cuisse de poulet sans peau marinée au paprika doux + chou rouge et carottes râpées", "Filet de daurade royale mariné au citron vert + poêlée méditerranéenne", "Steak de bœuf au four à l'ail et au thym + poivrons grillés et aubergines", "Filet de colin rôti à l'ail + betterave et noix", "Œufs brouillés aux herbes + salade de radis et concombre", "Langouste grillée au citron + asperges et champignons", "Filet de poulet grillé au citron + épinards et pignons de pin", "Crevettes poêlées minute au paprika + aubergines rôties et poivrons", "Blanc de poulet au four à l'ail et au thym + haricots verts et amandes effilées", "Frittata légère aux courgettes + carottes rôties et cumin", "Rôti de veau grillé au poivre + brocoli vapeur et carottes", "Filet de sole grillé au poivre + betterave et noix", "Filet de bœuf grillé au citron + salade de concombre et menthe", "Gambas sautées à l'ail et au persil + haricots verts et échalotes", "Langouste poêlée minute au paprika + carottes rôties et cumin", "Gambas vapeur à l'aneth + épinards sautés à l'ail", "Blanc de poulet rôti aux herbes de Provence + fenouil braisé et orange", "Frittata légère aux courgettes + aubergines rôties et poivrons", "Calamars en croûte d'herbes fraîches + carottes rôties et cumin", "Langouste sautée à l'ail et au persil + salade de tomates et basilic", "Filet de sole mariné au paprika doux + fenouil braisé et orange", "Crevettes à l'estragon + fenouil braisé et orange", "Filet de daurade royale mariné au citron vert + courgettes grillées et menthe", "Blanc de poulet en tranches fines au romarin + épinards et pignons de pin", "Suprême de poulet poêlé minute au paprika + aubergines rôties et poivrons", "Langouste au wok gingembre-citronnelle + chou-fleur rôti et curcuma", "Crevettes rôties à l'ail + salade de roquette et parmesan", "Escalope de dinde au wok gingembre-citronnelle + salade verte et avocat", "Gambas en croûte d'herbes fraîches + salade de concombre et menthe", "Gambas marinées au paprika doux + salade de radis et concombre", "Steak de bœuf sauté à l'ail et au persil + fenouil braisé et orange", "Filet de bœuf mariné au citron vert + chou rouge et carottes râpées", "Calamars rôtis à l'ail + aubergines rôties et poivrons", "Filet de sole rôti aux herbes de Provence + aubergines rôties et poivrons", "Escalope de veau à l'estragon + salade verte et avocat", "Langouste à l'estragon + chou rouge et carottes râpées", "Filet de colin sauté à l'ail et au persil + betterave et noix", "Filet de sole rôti aux herbes de Provence + asperges et champignons", "Blanc de poulet poêlé à la moutarde + poivrons grillés et aubergines", "Blanc de poulet vapeur à l'aneth + salade de roquette et parmesan", "Filet de sole rôti à l'ail + salade de concombre et menthe", "Frittata légère aux courgettes + poivrons et oignons confits", "Cuisse de poulet sans peau grillée au poivre + poêlée méditerranéenne", "Gambas sautées à l'ail et au persil + courgettes et menthe fraîche", "Rôti de veau en tranches fines au romarin + salade de tomates et basilic", "Crevettes en tranches fines au romarin + chou rouge et carottes râpées", "Œufs cocotte à la tomate + carottes rôties et cumin", "Filet de maquereau vapeur à l'aneth + salade de tomates et basilic", "Calamars rôtis aux herbes de Provence + courgettes et menthe fraîche", "Pavé de thon mariné au paprika doux + salade de betterave et roquette", "Filet mignon de porc mariné au paprika doux + asperges et champignons", "Filet mignon de porc au wok gingembre-citronnelle + salade de concombre et aneth", "Filet de cabillaud poêlé minute au paprika + haricots verts et échalotes", "Pavé de saumon poêlé minute au paprika + chou rouge et carottes râpées", "Filet de cabillaud en tranches fines au romarin + aubergines rôties et poivrons", "Gambas à l'estragon + haricots verts et amandes effilées", "Filet de lieu noir rôti à l'ail + chou-fleur rôti et curcuma", "Blanc de poulet poêlé minute au paprika + salade de fenouil et orange", "Filet de poulet rôti aux herbes de Provence + salade de radis et concombre", "Filet de poulet poêlé à la moutarde + carottes rôties et cumin", "Noix de Saint-Jacques vapeur à l'aneth + salade verte et avocat", "Noix de Saint-Jacques rôties à l'ail + salade verte et avocat", "Omelette aux poivrons + salade de roquette et parmesan", "Omelette aux champignons + ratatouille légère", "Filet de daurade royale grillé au poivre + poêlée méditerranéenne"];
...
function buildNextCycle(){
 ...
 function pickNoRepeat(pool,history,seed){
 ...
 for(let k=0;k<28;k++){
   ...
   const lunchChoice=pickNoRepeat(lunches,lunchHistory,k*5+3);
   const dinnerChoice=pickNoRepeat(dinners,dinnerHistory,k*7+2);
   lunchHistory.push(lunchChoice);dinnerHistory.push(dinnerChoice);
   extra.push({day:dayNames[k%7],week:Math.floor(BASE_M.length/7)+1+Math.floor(k/7),lunch:'Entrée : '+ALL_STARTERS[idx%ALL_STARTERS.length]+' • Plat : '+lunchChoice,snack:'',dinner:dinnerChoice});
 }
